...
const TRIP_ACTIONS = [
  { id: 'MURREE', eyebrow: 'Trip Planning', title: 'Planning Murree trip?', body: 'Check road, weather, and route alerts before you leave.', emoji: '🏔️' },
  { id: 'M2', eyebrow: 'Drive Status', title: 'Lahore to Islamabad', body: 'See M2 conditions, NHMP advisories, and stop-by-stop weather.', emoji: '🛣️' },
];
