...
- Server alert engine now covers: PMD severe/extreme CAP alerts, severe AQI threshold alerts, wind alerts, thunderstorm alerts, rain alerts (heavy and light), and morning summaries. Remaining hardening follow-ups: NHMP closure/fog, extreme heat, smog season, pollen, route-specific alerts, and delivery dashboard
